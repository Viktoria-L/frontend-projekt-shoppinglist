...
export function createDebugElements(bool) {
    ...
    getAllListsButton.addEventListener("click", async () => console.log(await getAllLists()));
    ...
    getAllListsOfflineButton.addEventListener("click", async () => console.log(await getAllListsOffline(offlineList)));
    ...
    filterOfflineButton.addEventListener("click", async () => filterByNameOffline(name));
