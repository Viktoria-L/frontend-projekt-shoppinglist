...
* :art: export hideCreateListButton (and show) functions in module ([89bac93](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/89bac9371701c89701c6ad01ce440c38631e1fb9))
* :bento: add symbol with id to svgs so they can be used with fancy <use> tag ([353608c](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/353608c6d38e4bbd87b5394adc8c27113503b929))
* :lipstick: add animations.css file ([032b9b3](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/032b9b3c4047082b26082e2f59b96140ad0ef0c7))
* :lipstick: add animations.css file with animations ([bf8870e](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/bf8870e63b0d21466609d0f6019c2f52c22137ae))
* :lipstick: updates header in browser when color is chosen ([2528cf5](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/2528cf5282ae952de33732059c81001eedf0f6a2))
* :sparkles: add and run hideEditButton(); in settings view ([e170cf1](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/e170cf1fb8650fa36993340c87d0d157a1e69e67))
* :sparkles: add animations.css file to index.html ([56e80ac](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/56e80aceb9f6f08b23fd11300f527c8175e42d8e))
* :sparkles: add module-animations.js with animation functions ([f30ad88](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/f30ad8849290a30ae941a5977639dadb52219594))
* :sparkles: color can be updated to api in edit-view ([38eb107](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/38eb1076893f9fee393f2826df87ae8c925017f8))
* :sparkles: import showUpdateModal in main.js (for now) ([1f89374](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/1f89374a2746b66c6659765d9a953b80252464c4))
* :sparkles: import showUpdateModal into edit view and trigger when text is edited ([8e150d0](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/8e150d0fe32b86615689c93fa7b5ae48aee812d0))
* :sparkles: updating listname to api on enter/loses focus ([f303d5f](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/f303d5f7291041d82b5ae7f11bc6c44f59584425))
* :tada: adding function ([390307e](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/390307ed8f5b62d9ad5a47059ff9f6f6c63876e6))
* :zap: replace img with svg in index.html ([d0af8b3](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/d0af8b3623417e34559d0a2f3e2b5cf30145dd6d))
* :zap: replace img with svg in module-display-lists.js ([23cdb71](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/23cdb71cbe389c0d990aced87589b5a9bce994cf))
* :zap: replace img with svg in module-settings.js ([f6a411b](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/f6a411b48b39441c399cee22f8f149977973a861))
* :zap: replace img with svg in modules-testing.js ([89c1c7c](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/89c1c7c4a4c76222d485a1304f4fb4c02f340ef4))
* :zap: replace img with svg in stateEditMode.js ([60d937d](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/60d937d3b00e72db6db1f4b66bff1366d39e94ba))
* :zap: replace img with svg in stateViewMode.js ([0821057](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/08210579d68db003282238188c558f7c123670cf))
* **CSS:** :lipstick: add a few CSS variables ([5055e72](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/5055e72e63993604407a118e632fc7ec8db91ab5))
* **CSS:** :lipstick: add css variables for colors and main ([4675760](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/46757602e00a38b219898cea053fead9e07b900d))
* **CSS:** :lipstick: improve animation modal styling ([274f1cb](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/274f1cb209e1c102e8705129dd79fdd8c2962b6d))
* **CSS:** :lipstick: replace css img selectors with svg ([c97aa7f](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/c97aa7f5403e680451dbe2092ceb658d9f9447d8))
* **CSS:** :lipstick: use css variables for list colors, main ([4217f73](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/4217f73c25776b283402303f93339048b0b66cd4))


### Bug Fixes

* :ambulance: remove liveserver port from settings.json ([cb5d36d](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/cb5d36d2032db9a4876777d870d64abd016c124a))
* :art: remove whitespace ([80cc175](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/80cc175b23dafa3933516e519ac9d5013094ee36))
* :bug: ([cdbb226](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/cdbb22625551832105d47ff8e77479266f76db35))
* :bug: ([f665a72](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/f665a7241c52ef24f8b06194c72f8882a1de23d9))
* :bug: ([4007242](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/400724242aa43f680415eccf1e8b2dd21bde2e22))
* :bug: add hidden class to newListBtn in .html ([f980f47](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/f980f4793c662de54390c8da6e07e1cc484c502a))
* :bug: add hover class to backBtn in create list ([528f593](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/528f5938918f5b8f9a37e039dc09fdc20f971e2a))
* :bug: add modal to main instead, take text argument ([cf425b0](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/cf425b04324f424180ef3c6a436639582976ed81))
* :bug: after saving view the added list ([c972c85](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/c972c850a2271e98dcdac350c261525ba63b65ae))
* :bug: delete list item online ([0e07820](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/0e07820b74d216bfa4eef1c5697e8b417d2a0176))
* :bug: delete-list-function-online-again ([0df1d5b](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/0df1d5b06780fdd6720d9d0b6b1e05e2239f30b5))
* :bug: finding right id ([6f5b3ff](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/6f5b3ffe8c5b8e65103db4281ed2d32f7b9898c5))
* :bug: fix 404         maybe? ([bcd1302](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/bcd1302b0643dcb271ebac1828b588c12ff44862))
* :bug: fix back button click not going back to index when list was not saved ([d1dd480](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/d1dd48012388f8acacec5e1c27780db8f2353e1e))
* :bug: fix back button in edit view not going to see list view ([9868524](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/9868524332fcf4ed3cf9218479d8d279edbf47af))
* :bug: fix clicking edit mode button not showing the updated value ([1966d9c](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/1966d9c60605fca90f0796a8af47d75f7d1365c1))
* :bug: fix image links ([7056cdd](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/7056cdd27a9c740a2ebfcccc5fc7f7540231b3dc))
* :bug: fix image links maybe ([6605996](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/6605996516d0cc9b83c31ca23a93b0d6460be49d))
* :bug: fix modal to show when it should ([7acab95](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/7acab957faf59a7b94a142af7fb2d80cac227d58))
* :bug: fix update modal not showing when creating list ([6b66286](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/6b66286a3d1bbd5080268fabb4f56e130dcb9a4a))
* :bug: fix-color-update ([c170a0b](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/c170a0b2199ad55e3d559c5b81c28af67f0e987f))
* :bug: fixing update list title function ([97cb60f](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/97cb60fb9861a03b53c6b51f9bf8218b0f310465))
* :bug: hide create list button directly when clicking a list from index ([1ad9821](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/1ad9821922bfb68e47d7c44a124b9b474a3495d1))
* :bug: hide header name in settings view clicked from create list view ([4bb2854](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/4bb2854631c163e1cca91cc46ec5636ed1b908f3))
* :bug: hide plus button in create list view ([854acb6](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/854acb6028fe268c9d9dc76dd6f678cfad8e6399))
* :bug: list-name can't be blank/same ([eec8c48](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/eec8c485041cac1815bd14902f9ae4990104788a))
* :bug: remove create list button stuff ([d442ac1](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/d442ac1ff33a84a27a804479d569f40edd070b83))
* :bug: remove showing of create list button here ([c39aa02](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/c39aa02e8b5d52ffc23b28edb8868a4c4d2f96b4))
* :bug: removes ! and ? ([26abe94](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/26abe942f66f8cb1d0e0eb728a011902739b5e0a))
* :bug: show create list button after loading is complete ([a8bf55c](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/a8bf55c63d82425206897093376562e1a9231e19))
* :bug: shows lists in reversed order ([21bcab5](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/21bcab5d1425ff55da81a2f243bbe4bb0b6c1967))
* :bug: sorting out signs ([cc1c683](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/cc1c683e5db56542667e161eb598cc98795511a2))
* :bug: update selectedList to the saved list ([7985253](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/79852531a2268d2a0880196479f51c9ee0ac3f6e))
* :fire: remove default.css and style.css from index.html ([0c53b8f](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/0c53b8fc14d08bce7bc0fd4bf4bc7eebe7dc9842))
* :fire: remove import from main.js ([a452968](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/a4529683b2910bf2179c4f8f942351489c676e8c))
* :fire: remove show create list button code ([e9ca59e](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/e9ca59eb3a04fb7fc774a571b804d637750dc520))
* :fire: remove style.css and default.css ([ff697a6](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/ff697a622db6bf7a1e218235042c0d6004674529))
* :fire: remove unused else statement ([92b82ed](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/92b82ed17c0ebf1b4da63a2be63c94130f852b87))
* :lipstick: update animation styling ([078f1e6](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/078f1e66a5e673acf39fb86b12715b2105211871))
* :recycle: move style.css and default.css contents to index.css ([df6d78a](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/df6d78ae747691ca6aee9f1a1aa668db34316ea1))
* :recycle: rename button-editmode to editBtn ([ba75b80](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/ba75b80f3c8e0383eb7331ebeffa7fa0223c5807))
* **CSS:** :art: change text-color variable to color ([0ff8cf6](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/0ff8cf6ca8658a511fe5b6a54891da6a8d717b63))
* **CSS:** :bug: add missing hover classes to backBtn in view and edit views ([9eba70b](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/9eba70bb61c1349691b566979037b47855a00963))
* **CSS:** :bug: move id and width inside svg tag ([fa0a506](https://github.com/Viktoria-L/frontend-projekt-shoppinglist/commit/fa0a506a7f66a30605d11767819a373e856ecb48))
